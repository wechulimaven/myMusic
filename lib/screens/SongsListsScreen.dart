...
import 'package:theHit/constants/const.dart';
import 'package:theHit/models/songs.dart';
import 'package:theHit/screens/playingNow.dart';
import 'package:theHit/screens/playlist.dart';
import 'package:theHit/services/databaseHelpers.dart';
import 'package:theHit/services/musicHandler.dart';

import 'albumScren.dart';
...
class SongsListScreen extends StatefulWidget {
  SongsListScreen(
      this.audioPlayer, this.songs, this.fav, this.recent, this.mostPlayed);
  ...
  @override
  SongsListScreenState createState() =>
      new SongsListScreenState(audioPlayer, songs, fav, recent, mostPlayed);
}
...
class SongsListScreenState extends State<SongsListScreen>
  ...
  void initState() {
    ...
    _dragAlignment =
        Alignment(ourMap(initPage, 0, _kTabs.length - 1, -1, 1), 0);
      ...
      setState(() {
        ...
        if (selectedSong != songsList.length - 1) {
          ...
          ScopedModel.of<SongModel>(context).updateSong(
              songsList[selectedSong], selectedSong, songsList, isPlaying);
        }
      });
    });
  ...
  initPlayer() {
    ...
    _audioPlayer.setCompletionHandler(() {
      ...
      songsList[selectedSong - 1].timeStamp =
    ...
    ScopedModel.of<SongModel>(context)
        .updateSong(_recentSongs[0], recentIndex, songs, false);
  }
...
//                                    },
                                    ...
                                    onChanged: (String value) {
                                      if (value.trim() == "") {
                                        ...
                                        if (_searchHeightController.status !=
                ...
                Expanded(
                  child: PageView(
                    ...
                    children: <Widget>[
                      for (int i = 0; i < _kTabs.length; i++) _kTabPages[i]
                    ],
                  ),
                ),
              ],
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => NowPlaying(
                                  alreadyPlaying: model.isPlayingSong
                                      ? model.isPlaying
                                      : false,
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return ListTile(
                            ...
                            leading: CircleAvatar(
                              radius: 20,
                              child: !(searchResults[index].albumArt == null)
                                  ? ClipRRect(
  ...
  Widget _buildHome() {
    ...
    return SingleChildScrollView(
      padding:
          EdgeInsets.only(bottom: (model.isPlayingSong ?? false) ? 0 : 100),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          (_recent.length != 0 && _recent[0].timeStamp != 0)
              ? Padding(
          ...
          (_recent.length != 0 && _recent[0].timeStamp != 0)
              ? Container(
                  ...
                  child: PageView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return (_recent[index].timeStamp == 0)
                          ? null
                          : Card(
                              ...
                              child: ListTile(
                                ...
                                leading: CircleAvatar(
                                  backgroundColor:
                                      Theme.of(context).accentColor,
                                  radius: 20,
                                  child: !(_recent[index].albumArt == null)
                                      ? ClipRRect(
                                          borderRadius:
          ...
          (_fav.length != 0)
              ...
              : SizedBox(),
          (_mostPlayedSongs.length != 0 && _mostPlayedSongs[0].timeStamp != 0)
              ? Padding(
                  padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                  child: Text(
                    'Most Played',
              ...
              ? Container(
                  ...
                  child: PageView.builder(
                    ...
                    controller:
                        PageController(initialPage: 0, viewportFraction: 0.9),
                    itemBuilder: (BuildContext context, int index) {
                      return (_mostPlayedSongs[index].count == 0)
                          ? null
                          : Card(
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.all(
                              ...
                              child: ListTile(
                                ...
                                leading: CircleAvatar(
                                  backgroundColor:
                                      Theme.of(context).accentColor,
                                  radius: 20,
                                  child: !(_mostPlayedSongs[index].albumArt ==
                                          null)
                                      ? ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(20),
  ...
  Widget _buildSongList() {
    return Stack(
      children: <Widget>[
        ScopedModelDescendant<SongModel>(
          builder: (context, child, model) {
            return Container(
              ...
              child: ListView.builder(
                padding:
                    EdgeInsets.only(bottom: (model.song != null) ? 100 : 0),
        ...
        Positioned(
          bottom: (ScopedModel.of<SongModel>(context).songs == null) ? 25 : 100,
          right: 25,
                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => AlbumScreen(
                              albums[albumNames[index]], _audioPlayer)));
                },
                child: Container(
                  child: Column(
                    children: <Widget>[
                      ClipRRect(
                        ...
                        child: Material(
                          ...
                          child: Container(
                            ...
                            child:
                                !(albums[albumNames[index]][0].albumArt == null)
                                    ? ClipRRect(
                                        borderRadius: BorderRadius.only(
                                          topRight: Radius.circular(10),
                                          topLeft: Radius.circular(10),
              ...
              return InkWell(
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          PlaylistScreen(_recent, _audioPlayer),
                    ),
                  );
                },
                child: Container(
              ...
              return InkWell(
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          PlaylistScreen(_mostPlayedSongs, _audioPlayer),
                    ),
                  );
                },
                child: Container(
