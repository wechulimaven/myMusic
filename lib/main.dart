...
import 'screens/SongsListsScreen.dart';
import 'services/databaseHelpers.dart';
...
class FrequencyHomeState extends State<FrequencyHome>
            ...
            Navigator.pushAndRemoveUntil(
              ...
              MaterialPageRoute(
                builder: (context) => SongsListScreen(
                    audioPlayer, songs, fav, recent, mostPlayed),
              ),
              (route) => false,
            )
          });
      ...
      try {
        ...
        if (songs == null || songs.length == 0) {
          ...
          for (Song song in songs) {
            print('SONG INSTANCE ${songs.length}');
          ...
          Navigator.pushAndRemoveUntil(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      SongsListScreen(audioPlayer, songs, [], [], [])),
              (route) => false);
        }
      } catch (e) {
          ...
          children: <Widget>[
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Column(
                  children: <Widget>[
                    isLoadingIntoDatabase
                        ? CircularProgressIndicator()
                        : SizedBox(),
                    isFetchingFromDatabase
                        ? CircularProgressIndicator()
                        : SizedBox(),
                    SizedBox(
                      height: 20,
